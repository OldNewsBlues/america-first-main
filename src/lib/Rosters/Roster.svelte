			...
			<Row>
				<Cell colspan=4 class="r_{division} clickable">
					<h3 on:click={() => gotoManager(roster.roster_id)}>
						<img alt="team avatar" class="teamAvatar" src="{user.avatar != null ? `https://sleepercdn.com/avatars/thumbs/${user.avatar}` : `https://sleepercdn.com/images/v2/icons/player_default.webp`}" />
